...
const (
	...
	GithubService_CreatePushWebhook_FullMethodName = "/github.GithubService/CreatePushWebhook"
	GithubService_TriggerWebHook_FullMethodName    = "/github.GithubService/TriggerWebHook"
)
...
func (c *githubServiceClient) CreatePushWebhook(ctx context.Context, in *GitWebHookInfo, opts ...grpc.CallOption) (*GitWebHookInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GitWebHookInfo)
	err := c.cc.Invoke(ctx, GithubService_CreatePushWebhook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GithubService_CreatePushWebhook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GitWebHookInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GithubServiceServer).CreatePushWebhook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GithubService_CreatePushWebhook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GithubServiceServer).CreatePushWebhook(ctx, req.(*GitWebHookInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GithubService_TriggerWebHook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(GithubServiceServer).TriggerWebHook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var GithubService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreatePushWebhook",
			Handler:    _GithubService_CreatePushWebhook_Handler,
		},
		{
			MethodName: "TriggerWebHook",
			Handler:    _GithubService_TriggerWebHook_Handler,
		},
	},
