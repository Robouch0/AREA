...
type HuggingFace struct {
	...
	RepoType string `bun:"repo_type" json:"type"`
	RepoName string `bun:"repo_name" json:"name"`

	RepoAction string `bun:"repo_action" json:"action"`
	RepoScope  string `bun:"repo_scope" json:"scope"`
