...
func (spot *SpotifyService) AddSongToPlaylist(_ context.Context, req *gRPCService.SpotifyAddSongToPlaylist) (*gRPCService.SpotifyAddSongToPlaylist, error) {
//     if req.SongUrl == "" || req.MillisecondsPosition == ""{
//         return nil, errors.New("Some required parameters are empty")
//     }
//     milliseconds, err := strconv.ParseInt(req.MillisecondsPosition, 10, 32)
...
//     }
	...
	bearerTok, _ := utils.GetEnvParameterToBearer("API_SPOTIFY")
	playlists, _ := spot.GetUserPlaylists(bearerTok)
